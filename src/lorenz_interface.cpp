...
These functions are intended only as interface and are called via a corresponding R interface,to provide a user-friendly R interface. See `R/lorenz-interface.R` for details.

Note: Generic functions for Drivers and OdeControl have been moved to ode_interface.cpp
*/
